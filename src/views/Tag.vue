    ...
    <div class="relative overflow-hidden bg-primary pt-[120px] md:pt-[130px] lg:pt-[160px]">
        <div class="container">
            <div class="-mx-4 flex flex-wrap items-center">
                <div v-if="$apollo.queries.postsByTag.loading" class="mx-auto my-10 w-10 h-10">
                    <span class="animate-spin-slow absolute inline-flex w-10 h-10 rounded-sm bg-white/50"></span>
                </div>
                <div v-if="postsByTag" class="w-full px-4">
    ...
    <section class="pt-20 pb-10 lg:pt-[120px] lg:pb-20">
        <div class="container">
            <div class="-mx-4 flex flex-wrap">
                <span v-if="$apollo.queries.postsByTag.loading" class="animate-spin-slow mx-auto w-20 h-20 rounded-sm bg-primary/50"></span>
                <div v-if="postsByTag" v-for="post in postsByTag" :key="post.title" class="w-full px-4 md:w-1/2 lg:w-1/3">
